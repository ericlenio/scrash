...
then, calling `-pw gmail` from the shell would copy your Gmail password onto
the OS clipboard. Note that a colon cannot be used as part of the password
since it is the delimeter.
